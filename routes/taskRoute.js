...
import { deleteTask, getAllTasks, getParticularTask, newTask, updateTask } from '../controllers/TaskController.js';

const router = express.Router(); 


router.post('/tasks/new_task', authUser, authField, authCrop, newTask)
router.get('/tasks/get_all_tasks', authUser, authField, authCrop, getAllTasks)
...
router.delete('/tasks/delete_task', authUser, authField, authCrop, authTask, deleteTask)
router.get('/tasks/getAllLogged_tasks', authUser, getAllTasks);
