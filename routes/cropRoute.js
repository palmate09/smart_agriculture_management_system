...
router.get('/crops/get_all_crops', authUser, authField, get_allCrops_ofParticularFramer); 
...
router.delete('/crops/delete_crop', authUser, authField, authCrop, DeleteCrop)
...
router.put('/crops/update_crop_growth_stage', authUser, authField, authCrop, updateGrowthStage)
