...
import { addExpenseDetails, deleteExpense, getAllExpenses, getExpenseDetails, getParticularExpense, newExpense, updateExpense } from '../controllers/ExpenseController.js'
const router = express.Router(); 


router.post('/expenses/new_Expense', authUser, authField, authCrop, newExpense); 
router.get('/expenses//get_all_expenses', authUser, authField, authCrop, getAllExpenses); 
...
router.delete('/expenses/delete_Expenses', authUser, authField, authCrop, authExpense, deleteExpense)
...
router.put('/expenses/update_ExpenseDetails', authUser, authField, authCrop, authExpense, updateExpense)
router.delete('/expenses/delete_ExpenseDetails', authUser, authField, authField,  authExpense, deleteExpense)
